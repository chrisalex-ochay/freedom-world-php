...
<head>
    ...
    <title>Bluetooth1 - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-25-bluetooth-earphones-jbl1-1.png" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-25-bluetooth-earphones-jbl1-1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-25-bluetooth-earphones-jbl2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-25-bluetooth-earphones-jbl3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-25-bluetooth-earphones-jbl4.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-25-bluetooth-earphones-jbl5.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
    ...
    <div class="small-container">        
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="../productfiles/product-36-earphones1-details.php"><h4>Packed-bass earphones</h4></a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
