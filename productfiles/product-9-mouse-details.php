...
<head>
    ...
    <title>Mouse - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-9-mouse-wired-11.png" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-9-mouse-wired-11.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-9-mouse-wireless-21.jpg" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
