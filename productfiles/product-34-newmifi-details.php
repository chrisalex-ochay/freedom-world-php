...
<head>
    ...
    <title>New-Mifi - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-34-New-4G-unlocked-mifi-1-1.jpg" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-1-1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-3.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-4.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-5.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-6.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-34-New-4G-unlocked-mifi-7.png" width="100%" class="small-img">
                    </div>
    ...
    <div class="small-container">        
        <div class="row">
            <div class="col-4">
                <a href="../productfiles/product-33-usedmifi-details.php"><img src="../images/product-33-Used-pocket-airtel-unlocked-mifi-1.jpg"></a>
                <a href="../productfiles/product-33-usedmifi-details.php"><h4>Used Unlocked Mifis</h4></a>
                <div class="rating">
