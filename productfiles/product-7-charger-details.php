...
<head>
    ...
    <title>Chargers - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-7-4ne-cable-chargers-1-1.jpg" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-7-4ne-cable-chargers-1-1.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-7-4ne-cable-chargers-2.jpg" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-7-4ne-cable-chargers-3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-7-4ne-cable-chargers-4-c-type.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                ...
                <br>
                <p>We have all USB chargers of all types, i.e flat types(normal smart phones) <br>
                   C-type(Newer phones), iPhone 4,5,6,8,X chargers <br> 
                   durable and long lasting chargers.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">        
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="../productfiles/product-8-light-details.php"><h4>Rechargeable Lights</h4></a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
            ...
            <div class="col-4">
                ...
                <a href="../productfiles/product-13-A12samsung-details.php"><h4>Sumsang Galaxy A21s</h4></a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
