...
<head>
    ...
    <title>Flasks - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-4-flask2.5-stainless-2.png" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-4-flask2.5-stainless-2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-4-flask2.5-stainless-3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-4-flask2.5-stainless-4.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-4-flask2.5-stainless-5.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-4-flask2.5-stainless-6.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
