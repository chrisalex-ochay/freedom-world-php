...
<head>
    ...
    <title>ScreenGuards1 - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-20-glass-screenguards1-1.png" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-20-glass-screenguards1-1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-20-glass-screenguards2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-20-glass-screenguards3.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
                <p>Screen guards</p>
                <h1>Glass Screen-guards</h1>
                ...
                <br>
                <ul>
                    <li>these are strong full-glass screen guards that protects your </li>
                    <li>smart phone screen when heat on a hard-surface</li>
                    <li>they are like using an umbrella during rainfall</li>
                    <li>they are cheap and easy to put on your phone.</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="small-container">        
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="../productfiles/product-31-simtablets-details.php"><h4>4G simcard TAB</h4></a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
