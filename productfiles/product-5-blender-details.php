...
<head>
    ...
    <title>Blender1 - Freedom World Technolories & Accesories</title>
...
<!-----------------------------   single product details  ---------------------->
    <div class="small-container single-product">
        <div class="row">
            <div class="col-2">
                <img src="../images/product-5-blender-zaiba-1-1.png" width="100%" id="ProductImg">

                <div class="small-img-row">
                    <div class="small-img-col">
                        <img src="../images/product-5-blender-zaiba-1-1.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-5-blender-zaiba-2.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-5-blender-zaiba-3.png" width="100%" class="small-img">
                    </div>
                    <div class="small-img-col">
                        <img src="../images/product-5-blender-zaiba-4.png" width="100%" class="small-img">
                    </div>
                </div>
            </div>
            <div class="col-2">
