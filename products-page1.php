...
<html lang="en">
    <head>
        ...
        <title>All Products-Page1 - Freedom World Technolories & Accesories</title>
...
<div class="small-container">
    ...
    <!-- <div class="page-btn">
        <a href="products-page1.html"><span>1</span></a>
        <a href="products-page2.html"><span>2</span></a>
        <a href="products-page3.html"><span>3</span></a>
        <span>&#8594</span> 
    </div> -->
    <div class="row">
        <div class="col-4">
        ...
        <div class="col-4">
            ...
            <a href="productfiles/product-3-bulb-details.php"><h4>Rechargeable Bulbs</h4></a>
            <div class="rating">
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
                <i class="fa fa-star"></i>
