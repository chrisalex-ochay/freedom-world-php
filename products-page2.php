...
<html lang="en">
    <head>
        ...
        <title>All Products-Page2 - Freedom World Technolories & Accesories</title>
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                ...
                <a href="productfiles/product-30-headphonesjbl2-details.php"><h4>Headphones</h4></a>
                <div class="rating">
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
                    <i class="fa fa-star"></i>
